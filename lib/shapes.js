...
class Square extends Shape {
  render() {
    return `<svg width="300" height="300" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="${this.setColor}" /><text x="50%" y="50%" text-anchor="middle" dy=".3em" fill="${this.textColor}" font-size="60" font-family="Arial">${this.text}</text></svg>`;
  }
}
