...
describe("Tests for Square Class", () => {
    ...
    test("will this return a square", () =>{
      const expectedReturn = `<svg width="300" height="300" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="red" /><text x="50%" y="50%" text-anchor="middle" dy=".3em" fill="blue" font-size="60" font-family="Arial">Arg</text>
      </svg>`
